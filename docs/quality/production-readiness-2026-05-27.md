...
| Runtime health endpoint | Public health route checks database, schema version, and storage directories without exposing secrets | REQUIRED | `curl -fsS http://127.0.0.1:8080/api/v1/health` |
