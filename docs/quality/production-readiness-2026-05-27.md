...
| Physical device proof | Real iPhone and Android emulator platform checks | PARTIAL; Android Emulator E2E passed, USB iPhone evidence remains missing |
...
| Mobile device QA | USB-connected iPhone and Android emulator run smoke or install/manual checklist | PARTIAL; Android native E2E passed, physical iPhone remains pending | `REQUIRE_PHYSICAL_IOS=1 REQUIRE_ANDROID_EMULATOR=1 RUN_PHYSICAL_IOS_E2E=1 RUN_ANDROID_E2E=1 ./scripts/check-mobile-device-qa-preflight.sh` |
