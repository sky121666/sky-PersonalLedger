...
python3 - "$ROOT_DIR/.github/workflows" "$ROOT_DIR/.forgejo/workflows" <<'PY'
import pathlib
import re
import sys


workflow_dirs = [pathlib.Path(value) for value in sys.argv[1:]]
...
print("GitHub and Forgejo Actions immutable pinning checks passed.")
PY
