...
require_text '^## 4\. Physical iPhone QA'
...
require_text 'RELEASE_ARTIFACT_DIR=artifacts RELEASE_VERSION=X.Y.Z REQUIRE_IOS_ARTIFACT=1 ./scripts/check-release-artifact-files.sh'
require_text 'REQUIRE_PHYSICAL_IOS=1 ./scripts/check-mobile-device-qa-preflight.sh'
