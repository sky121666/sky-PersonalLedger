...
func NewServices(repos *repository.Repositories, cfg *config.Config) *Services {
	...
	return &Services{
		...
		Transaction:  NewTransactionService(repos.Transaction, repos.Account, repos.Reminder, repos.Lending),
		Budget:       NewBudgetService(repos.Budget, repos.Transaction),
		Reminder:     NewReminderService(repos.Reminder, repos.Account, repos.Transaction, repos.Category),
		...
		Backup:       NewBackupService(repos.Account, repos.Category, repos.Transaction, repos.Budget, repos.Reminder, repos.Lending, repos.Template, repos.Notification),
		Notification: NewNotificationService(repos.Notification),
		Lending:      NewLendingService(repos.Lending, repos.Account, repos.Transaction, repos.Category),
